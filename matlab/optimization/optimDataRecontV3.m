% =========================================================================
% FINAL REAL DATA RECONSTRUCTION SCRIPT (v3.3 - Hyperparameter Tuning)
%
% Description:
...
fprintf('=== pMUT FINAL RECONSTRUCTION (v3.3) ===\n');
...
%   - Lower values (e.g., 1.5, 5) trust the data more, which can result
%     in a sharper but noisier image.
%   - RECOMMENDATION: Start by increasing this value significantly.
params.lambda_tv_reg = 50.0; % (Original: 1.5)

% rho_admm: The "Step Size" or "Penalty" parameter.
%   - This affects the convergence speed and stability. It's more complex
%     to tune. It's best to start by tuning lambda_tv_reg first.
params.rho_admm = 7.0;

% --- Performance & Debugging Settings ---
params.num_acquisitions_to_use = 70; 
