% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v2.2 - Digital Twin w/ Phase)
%
% Description:
% This version tests the hypothesis that re-introducing simulated phase
% shifts can improve the reconstruction of real data by creating a more
% incoherent H-matrix that better models real-world complexities.
%
% v2.2 Changes:
% - Re-enabled random phase shifts (use_phase_shifts = true) during H-matrix
%   simulation to test its impact on real data reconstruction.
% =========================================================================
clear; clc; close all;
...
% *** KEY CHANGE: Re-enabling phase shifts to test impact ***
params.use_phase_shifts = true;    % (Original: false)
