% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.4)
%
% Description:
...
%
% v1.4 Improvements:
% - Implements a main loop to simulate and reconstruct a variety of target
%   patterns ('3x3_grid', '2x2_grid', 'line_5', 'cross_5').
% - Optimizes the workflow by generating the computationally expensive
%   H-matrix only once and reusing it for each scene.
% - Organizes output into unique sub-folders for each tested scene.
% =========================================================================
clear; clc; close all;
