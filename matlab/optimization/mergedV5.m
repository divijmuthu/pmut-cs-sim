% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.3)
%
% Description:
...
%   variable, non-uniform target sizes and intensities for a more realistic
%   and challenging reconstruction task.
% - Increased the imaging grid resolution (finer grid step) to capture
%   more detail and increase the computational challenge.
% =========================================================================
clear; clc; close all;
...
% IMPROVEMENT: Finer grid for higher resolution and more compute time.
params.grid_step_m = 0.004;        % (Original: 0.0075)
params.target_pattern = '3x3_grid';
params.grid_spacing_mm = 25;       % Increased spacing for more complex targets
% IMPROVEMENT: More complex "Optimal Challenge" target scene
params.target_sizes_mm = [3, 3, 4, 4, 4, 5, 5, 5, 6];  % Balanced sizes
params.target_intensities = [0.8, 0.9, 1.0, 1.0, 1.1, 1.1, 1.2, 1.2, 1.3];  % Balanced intensity
