...
% Step 3: Quantum H matrix generation
...
% Step 5: Quantum ADMM reconstruction
quantum_admm(H, measurements, scene_matrix, imaging_grid, params, output_folder);
...
function quantum_admm(H, measurements, scene_matrix, imaging_grid, params, output_folder)
    % Quantum ADMM reconstruction
    ...
    fprintf('  Quantum ADMM: numIters=%d, rho=%g, lambda_TV=%g\n', ...
