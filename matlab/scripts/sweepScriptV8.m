% =========================================================================
% Comprehensive H-Matrix Parameter Sweep Script v6.9 (Definitive Fix)
%
% Description:
...
% - This change in physics creates a more focused, powerful acoustic
%   beam, which is the definitive fix for the low column norms and the
%   resulting "max_mutual_coherence = 0" issue.
% - Kept the increased excitation_amplitude to ensure a strong signal.
% =========================================================================
...
base_config.excitation_amplitude = 1e12; % Increased to overcome attenuation
