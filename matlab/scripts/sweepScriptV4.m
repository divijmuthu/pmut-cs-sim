% =========================================================================
% Comprehensive H-Matrix Parameter Sweep Script v6.4 (Definitive Fix)
%
% Description:
...
%
% v6.4 Fixes & Features:
% - COMPLETE REFACTOR to precisely emulate the user's proven v3.3 script.
% - Corrected the xdc_excitation call to be xdc_excitation(TxAperture,
%   ones(1, num_active_tx)), which was the definitive bug causing the
%   simulation to fail and produce zero-coherence results.
% - This version is built on a known-good simulation model and should
...
base_config.num_acquisitions = 100; % Reduced for faster debug, was 150
...
function H = generate_h_matrix(config)
    ...
    for r_acq = 1:config.num_acquisitions
        ...
        % *** DEFINITIVE FIX v6.3: Apply impulse AND correct excitation ***
