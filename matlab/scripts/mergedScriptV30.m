% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.0)
%
% Description:
% This script integrates the best components from previous development into
% a single, cohesive, end-to-end simulation framework. It combines:
%   1. The most advanced, physically realistic H-matrix generation with
%      maximum geometric and signal diversity.
%   2. Sophisticated target scene generation with configurable patterns,
%      sizes, and spacings.
%   3. A full forward simulation to generate noisy measurements.
%   4. A complete ADMM reconstruction algorithm to produce a final image.
%   5. Comprehensive analysis and visualization of the results.
%
% =========================================================================
clear; clc; close all;
...
params.num_acquisitions = 25;      % Number of random acquisitions
...
params.tx_pool_width_m = 0.200;    % Width of the area for random transducer placement
...
params.grid_step_m = 0.005;        % Resolution of the imaging grid (5mm)
