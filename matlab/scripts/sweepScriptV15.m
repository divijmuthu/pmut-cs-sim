% =========================================================================
% Final Synthesized H-Matrix Parameter Sweep Script v11.1
%
% Description:
% This version fixes a syntax error in the receiver definition, ensuring
% the simulation runs correctly with the randomized transducer grid.
%
% v11.1 Fixes:
% - Replaced incorrect xdc_focused_array call with the correct
%   xdc_rectangle function for defining the single, fixed receiver.
% =========================================================================
clear; clc; close all;
...
function H = generate_h_matrix_final(config)
    ...
    % --- Define a SPARSE, RANDOMIZED pool of potential element locations ---
    total_elements = 81;
    ...
    % *** FIX IS HERE: Use xdc_rectangle for a single element ***
    % --- Define the FIXED Receiver at the center ---
    w = config.pmut_width_m; % shorthand
    corners = [-w/2 -w/2 0; w/2 -w/2 0; w/2 w/2 0; -w/2 w/2 0];
    RxAperture = xdc_rectangle(corners, [0 0 0], [1 1 1]);
