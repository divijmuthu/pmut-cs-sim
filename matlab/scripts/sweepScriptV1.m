% =========================================================================
% Comprehensive H-Matrix Parameter Sweep Script v5.6
%
% Description:
...
%
% v5.6 Fixes:
% - Corrected the "Apodization mxArray must have one column for each
%   physical aperture element" error.
% - The apodization and delay vectors now correctly match the size of the
%   temporary apertures created in each acquisition loop.
% =========================================================================
