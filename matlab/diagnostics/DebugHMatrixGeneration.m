% Debug H Matrix Generation
% Test the H matrix generation step by step to find the issue
clearvars;
clc;
close all;

%% Test H matrix generation with simple parameters
fprintf('--- Debugging H Matrix Generation ---\n');
...
sgtitle('H Matrix Generation Debug');
set(gcf, 'Color', 'w');
