% =========================================================================
% Comprehensive Data Diagnostic Script v4.4 (Distance Corrected)
%
% Description:
% This version adjusts the simulated target distance based on the arrival
% time of the measured echo to achieve a better alignment between the
...
fprintf('--- Comprehensive Diagnostic Script v4.4 (Distance Corrected) ---\n');
...
% *** FIX: Define target position based on measured echo arrival time ***
