% =========================================================================
% EXPERIMENTAL DATA RECONSTRUCTION SCRIPT v3.6 (Final w/ Coherence Plot)
%
% Description:
% This is the final, fully integrated script. It includes a proper
% diagnostic section that both calculates the numerical max coherence and
% displays a plot of the coherence matrix itself.
%
% v3.6 Improvements:
% - Replaced all previous diagnostics with a single, correct coherence
%   analysis section as requested.
% - Generates a plot of the coherence matrix for visual inspection.
% =========================================================================
clear; clc; close all;

%% ===== 1. CONFIGURATION =====
fprintf('=== Experimental Data Reconstruction Script (v3.6) ===\n');
...
if max_coherence < 1e-6
    fprintf('  WARNING: Max coherence is zero or near-zero. This indicates a potential\n');
    fprintf('           simulation issue where only one pixel is receiving a signal.\n');
end
