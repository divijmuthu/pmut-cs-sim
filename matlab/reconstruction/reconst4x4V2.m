...
%
% v1.5 Improvements:
% - Implemented a fixed 4x downsampling factor for the experimental data.
...
params.c = 343;
% params.fs will be determined by downsampling the experimental data
...
params.downsample_factor = 4; % <-- Downsample by a factor of 4
...
params.fs = original_fs / params.downsample_factor; % Set final fs
fprintf('  Original Fs: %.2f MHz. Downsampled Fs: %.2f MHz.\n', original_fs/1e6, params.fs/1e6);
...
b_vector_resampled = downsample(processed_data, params.downsample_factor);
