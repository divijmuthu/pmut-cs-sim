% =========================================================================
% FINAL REAL DATA RECONSTRUCTION SCRIPT (v4.7 - Gold Standard Operator)
%
% Description:
% This is the definitive, memory-safe, and physically correct reconstruction
% script. It combines the "Gold Standard" physics model from v4.6 with the
% memory-efficient "forward operator" method. This avoids building the
% massive H-matrix, preventing crashes while ensuring the most accurate
% simulation of the real-world hardware.
%
% v4.7 Improvements:
% - Re-instated the memory-safe forward operator method.
% - Uses the physically correct simulation of individual pMUT elements.
% - Retains the proven ADMM hyperparameters from the v1.5 simulation.
% =========================================================================

clear; clc; close all;

%% ===== 1. CONFIGURATION AND FILE SELECTION =====
fprintf('=== pMUT FINAL RECONSTRUCTION (v4.7) ===\n');
