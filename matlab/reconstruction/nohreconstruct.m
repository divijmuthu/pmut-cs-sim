% =========================================================================
% All-in-One Compressed Sensing Reconstruction v9 (PCG Regularization)
%
% Description:
% This script performs the complete end-to-end reconstruction process.
% It uses a memory-efficient "matrix-free" approach and includes all
% necessary scaling and regularization for robust performance.
%
% Workflow:
% 1. Loads the delay profiles (.csv) and measured echo data (.h5).
% 2. Simulates the corresponding physics using Field II.
% 3. Reconstructs the image from the measured data.
% =========================================================================
...
fprintf('--- All-in-One Reconstruction Script v9 (PCG Regularization) ---\n');
...
maxItersCG_main = 200;
tolCG_main = 1e-6;
alpha_pcg_reg = 1e-4;   % Regularization parameter for PCG
...
fprintf('  Calculating Least Norm (PCG) with Tikhonov Regularization...\n'); tic;
AAtfun_pcg_reg = @(y_vec) Afun_scaled(Atfun_scaled(y_vec)) + alpha_pcg_reg * y_vec;
