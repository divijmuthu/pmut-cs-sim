% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.13 - 4x4 Corrected Physics)
%
% Description:
% This is the definitive simulation to test a realistic, high-performance
% experimental setup. It models a 4x4 grid of pMUTs with corrected physical
% dimensions (2mm width, 2mm kerf) and uses the most powerful method for
% generating diversity: randomly selecting sparse transmit AND receive
% apertures for each acquisition.
%
% v1.13 Improvements:
% - Simulates a fixed 4x4 grid of 16 pMUTs.
% - Corrected physical parameters to `pmut_width_m = 0.002` and `kerf_m = 0.002`.
% - Implements random sparse transmit AND receive apertures.
% - Runs the full test suite of target patterns from v1.5.
% - Builds the full H-matrix for a definitive coherence analysis.
% =========================================================================
clear; clc; close all;

%% ===== 1. MAIN SIMULATION CONFIGURATION =====
fprintf('=== pMUT SIMULATION (v1.13 - 4x4 Corrected Physics) ===\n');
...
params.c = 343;
params.fs = 1e6;
% *** NEW: Corrected physical parameters ***
params.pmut_width_m = 0.002; % 2mm active element width
params.kerf_m = 0.002;       % 2mm spacing between elements
params.excitation_amplitude = 1e12;
params.target_SNR_db = 100iite;
