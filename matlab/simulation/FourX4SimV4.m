% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.12 - Corrected Physics)
%
% Description:
% This version corrects a critical error in the physical parameters of the
% simulation. The pMUT element width has been corrected from 20mm to 2mm
% to accurately model the real hardware.
%
% v1.12 Improvements:
% - Corrected `params.pmut_width_m` to 0.002 (2 mm).
% - Updated `params.kerf_m` to a more realistic default value.
% =========================================================================
clear; clc; close all;

%% ===== 1. MAIN SIMULATION CONFIGURATION =====
fprintf('=== pMUT SIMULATION (v1.12 - Corrected Physics) ===\n');
...
params.c = 343;
params.fs = 1e6;
% *** FIX: Corrected pMUT width from 20mm to 2mm ***
params.pmut_width_m = 0.002;
% NOTE: Measure the space between your real pMUTs and update this value.
params.kerf_m = 0.002; % A reasonable default of 2mm spacing
