% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.11 - Full H & Coherence)
%
% Description:
% This is the definitive, optimized simulation script. It combines all
% successful strategies and re-introduces explicit H-matrix generation
% (using a memory-safe chunking method) to allow for direct coherence
% analysis.
%
% v1.11 Improvements:
% - Builds the full H-matrix instead of using a forward operator.
% - Adds a coherence analysis step with visualization after H is generated.
% - Retains random Tx/Rx apertures and the full test suite.
% =========================================================================
clear; clc; close all;

%% ===== 1. MAIN SIMULATION CONFIGURATION =====
fprintf('=== pMUT SIMULATION (v1.11 - Full H & Coherence) ===\n');
...
params.assembly_chunk_size = 25; % For memory-safe assembly
...
% (Other helper functions like create_scene, run_forward_simulation, etc. are unchanged)
% ...
