% =========================================================================
% UNIFIED PMUT ULTRASOUND SIMULATION SCRIPT (v1.14 - Compact 4x4 Grid)
%
% Description:
% This version enhances the 4x4 grid simulation by using physically
% realistic dimensions for a compact array. It models small 2mm pMUTs that
% are packed closely together with a 0.5mm kerf. This provides the most
% accurate possible test of a practical, high-performance sparse array.
%
% v1.14 Improvements:
% - Simulates a fixed 4x4 grid of 16 pMUTs.
% - Uses corrected physical parameters: `pmut_width_m = 0.002` (2mm).
% - Uses a realistic `kerf_m = 0.0005` (0.5mm) for a compact array design.
% =========================================================================
clear; clc; close all;

%% ===== 1. MAIN SIMULATION CONFIGURATION =====
fprintf('=== pMUT SIMULATION (v1.14 - Compact 4x4 Grid) ===\n');
...
params.c = 343;
params.fs = 1e6;
% *** NEW: Corrected physical parameters for a compact array ***
params.pmut_width_m = 0.002; % 2mm active element width
params.kerf_m = 0.0005;      % 0.5mm spacing between elements
