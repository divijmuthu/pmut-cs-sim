% =========================================================================
% FINAL REAL DATA RECONSTRUCTION SCRIPT (v3.6 - Aggressive Tuning)
%
% Description:
% This is the definitive, memory-safe reconstruction script. This version
% is configured with aggressive hyperparameter settings designed to combat
% the strong artifacts present in the real data and reveal the faint
% target signal. It combines the forward operator method with parameters
% tuned for high-noise, high-artifact environments.
%
% v3.6 Improvements:
% - ADMM parameters (`lambda_tv_reg`, `rho_admm`) have been made much more
%   aggressive to prioritize artifact removal and denoising.
% - Increased the default number of ADMM iterations.
% =========================================================================

clear; clc; close all;

%% ===== 1. CONFIGURATION AND FILE SELECTION =====
fprintf('=== pMUT FINAL RECONSTRUCTION (v3.6) ===\n');
...
% These are aggressive settings designed for very noisy data with strong artifacts.
params.lambda_tv_reg = 150.0; % Very high value to force smoothness and remove artifacts
params.rho_admm = 5.0;        % Lower value to trust noisy data less
params.admm_max_iter = 150;     % More iterations to allow for convergence
