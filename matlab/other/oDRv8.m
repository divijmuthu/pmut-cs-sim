% =========================================================================
% FINAL REAL DATA RECONSTRUCTION SCRIPT (v4.2 - Optional Coherence)
%
% Description:
% This version is a definitive attempt to reconstruct the real-world data by
% aligning as closely as possible with the successful `v1.5` simulation.
% It now includes a toggle to skip the computationally expensive coherence
% analysis for faster iteration when desired.
%
% v4.2 Improvements:
% - Added a boolean flag `params.run_coherence_analysis` to make the
%   slow coherence calculation optional.
% =========================================================================

clear; clc; close all;

%% ===== 1. CONFIGURATION AND FILE SELECTION =====
fprintf('=== pMUT FINAL RECONSTRUCTION (v4.2) ===\n');
...
params.run_coherence_analysis = true; % Set to false to skip slow analysis
params.num_acquisitions_to_use = 30; 
...
% --- H-Matrix Diagnostics (Optional) ---
max_coherence_after = NaN;
if params.run_coherence_analysis
    fprintf('\n  --- H-Matrix Coherence Analysis ---\n');
    fprintf('  Calculating coherence of pruned H-matrix (this is a slow step)...');
    tic;
